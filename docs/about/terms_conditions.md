# MetaHQ Data Sources and Attribution
...
MetaHQ is released under **CC BY-NC 4.0** (Creative Commons Attribution-NonCommercial 4.0 International)
...
- **Sample annotations in MetaHQ:** 58,785
- **Study annotations in MetaHQ:** 1,891
...
- **Sample annotations in MetaHQ:** 1,736
- **Study annotations in MetaHQ:** 179
...
- **Source:** Golightly _et al_. Scientific Data (2018)
- **License:** CC0 1.0
...
- **Source:** Gu _et al_ (2023)
- **License:** CC0 1.0
- **Citation:** [Include complete citation]
- **Rights Statement:** From Rights and Permissions in paper
...
- **Source:** Jonson and Krishnan. bioRxiv (2023)
- **License:** CC BY 4.0
...
- **Source:** Sirota _et al_. Science translational medicine (2011)
- **License:** CC BY-NC (Version to be confirmed - likely 3.0)
...
- **Access:** Supplementary materials from open access article on PubMed Central
- **Note:** Published under Science Translational Medicine AAAS OpenChoice program
- **Sample annotations in MetaHQ:**
- **Study annotations in MetaHQ:**
- **⚠️ NonCommercial Restriction**
...
- **Paper License:** CC BY-NC 3.0 (http://creativecommons.org/licenses/by-nc/3.0/)
- **Access:** [GitHub/Zenodo URL]
- **Sample annotations in MetaHQ:**
- **Study annotations in MetaHQ:**
- **⚠️ NonCommercial Restriction**
...
When using MetaHQ in publications or presentations, please cite:
Hicks, P. et al. MetaHQ: Harmonized, high-quality metadata annotations of public omics samples and studies. arXiv, (2026).
AND acknowledge: "This work used annotations from MetaHQ, which integrates
curated metadata from [list specific sources used]."
...
- **CC BY sources:** CellO, CREEDS, Johnson_2023

```bash
# Filter for commercial-compatible annotations
metahq retrieve --term "UBERON:0000948" \
  --filter source_license="CC0,CC-BY"
```
...
**Licensing questions:** arjun.krishnan@cuanschutz.edu
**Contributing annotations:** See CONTRIBUTING.md
