"""
Logging configuration for metahq-setup.
...
class PipelineLogger:
    ...
    Examples:
        >>> pipeline_logger = PipelineLogger("metahq_setup.pipeline")
...
def get_default_log_file(package_root: Path) -> Path:
    ...
    Arguments:
        package_root (Path):
            Root directory of the metahq_setup package
    ...
    return log_dir / "metahq_setup.log"
